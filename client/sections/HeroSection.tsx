...
import Devendra from "../public/devendra-illustration.webp";
    ...
    >
        ...
        <div className="relative w-72 md:w-80 h-80 flex items-center mx-auto">
          <div className="absolute pointer-events-none scale-90 xs:scale-95 mx-auto">
            <Image
              ...
              aria-label="Devendra character illustration levitating with a Macbook"
              alt="Devendra character illustration"
            />
          </div>
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          ...
          <p>
            With my expertise in AI/ML model development. I bring a unique
